...
public class FetchService extends IntentService {
    private static final String LOG_TAG = FetchService.class.getSimpleName();
    ...
    private void processJSONdata(String JSONdata, Context mContext, boolean isReal) {
        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                ...
                if (league.equals(PREMIER_LEAGUE) ||
                    ...
                    try {
                        ...
                        try {
                             parsedDate = matchDate.parse(mDate + mTime);
                        } catch (Exception e) {
                        ...
                        if (!isReal) {
                            ...
                            Date fragmentdate = new Date(System.currentTimeMillis() + ((i - 2) * MainPagerFragment.HOURS_24));
                            mDate = Utilies.sdf.format(fragmentdate);
                        }
                    } catch (Exception e) {
                        Log.d(LOG_TAG, "error here!");
                        Log.e(LOG_TAG, e.getMessage());
            ...
            mContext.getContentResolver().bulkInsert(DatabaseContract.BASE_CONTENT_URI, insertData);
